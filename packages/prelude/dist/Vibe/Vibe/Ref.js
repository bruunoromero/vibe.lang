...
const $impl_Show_Ref_v1056_toString = ($dict_Show) => (ref) => String.$dict_Appendable_String._PLUS_PLUS("Ref(")(String.$dict_Appendable_String._PLUS_PLUS($dict_Show.toString(get(ref)))(")"));
const $impl_Eq_Ref_v1057__EQ_EQ = (x) => (y) => _eq(x)(y);
const $default_Eq_Ref_v1057__SLASH_EQ = (x) => (y) => not($dict_Eq_Ref_v1057._EQ_EQ(x)(y));
const $dict_Show_Ref_v1056 = ($dict_Show) => ({
  toString: $impl_Show_Ref_v1056_toString($dict_Show)
});
const $dict_Eq_Ref_v1057 = {
  _EQ_EQ: $impl_Eq_Ref_v1057__EQ_EQ,
  _SLASH_EQ: $default_Eq_Ref_v1057__SLASH_EQ
};

export { $dict_Eq_Ref_v1057, $dict_Show_Ref_v1056, create, get, set };
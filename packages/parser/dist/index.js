...
var get = (k) => (d) => _has(d)(k) ? Just(_unsafeGet(d)(k)) : Nothing;
var _toList = ($a0) => ($a1) => dictToList($a0, $a1);
var toList2 = _toList((k) => (v) => [k, v]);
...
var union = ($a0) => ($a1) => dictUnion($a0, $a1);
...
var emptyRegistry = dictEmpty;
var defaultOperatorInfo = { precedence: 9, associativity: AssocLeft };
var builtinRegistry = _PIPE_GT(_PIPE_GT(dictEmpty)(insert("&&")({ precedence: 3, associativity: AssocRight })))(insert("||")({ precedence: 2, associativity: AssocRight }));
...
var mergeRegistries = (base) => (override) => union(override)(base);
...
var peekKeyword = (kw) => (state) => ((tok) => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Keyword))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)(kw)))(current(state));
var peekOperator = (op) => (state) => ((tok) => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)(op)))(current(state));
var matchKind = (kind) => (state) => $dict_Eq_TokenKind._EQ_EQ(current(state).kind)(kind) ? Just(advance(state)) : Nothing;
var matchOperator = (op) => (state) => ((tok) => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)(op)) ? Just(advance(state)) : Nothing)(current(state));
...
var expectKeyword = (kw) => (state) => ((tok) => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Keyword))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)(kw)) ? Ok([tok, advance(state)]) : Err(makeError($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS("Expected keyword '")(kw))("' but found "))(tokenKindStr(tok.kind)))(" '"))(tok.lexeme))("'"))(tok.span)))(current(state));
var expectOperator = (op) => (state) => ((tok) => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)(op)) ? Ok([tok, advance(state)]) : Err(makeError($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS($dict_Appendable_String._PLUS_PLUS("Expected operator '")(op))("' but found "))(tokenKindStr(tok.kind)))(" '"))(tok.lexeme))("'"))(tok.span)))(current(state));
    ...
    if ($dict_Ord_Int._GT(limit)(20)) {
    ...
    } else {
      {
        ...
        if ($match_14.$tag === 0) {
          ...
          if (_AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)("=>"))) {
            return true;
          } else {
            if (_AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Keyword))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)("where"))) {
              return false;
            } else {
    ...
    } else {
      {
        ...
        if ($match_15.$tag === 0) {
          const tok = $match_15.$0;
          {
            ...
            if (_AMP_AMP3($dict_Eq_Int._EQ_EQ(newDepth)(0))(() => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)("=>")))) {
              return true;
            } else {
              if (_AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Keyword))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)("where"))) {
                return false;
          ...
          if ($dict_Eq_Int._SLASH_EQ(tok.span.start.line)(startLine)) {
          ...
          } else {
            {
              ...
              if (_AMP_AMP3($dict_Eq_Int._EQ_EQ(newDepth)(0))(() => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)("=>")))) {
                ...
                if (_AMP_AMP3($dict_Eq_Int._EQ_EQ(newDepth)(0))(() => _PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Equals))(() => $dict_Eq_TokenKind._EQ_EQ(tok.kind)(Keyword)))) {
                  return false;
                } else {
        ...
        if ($match_19.$tag === 0) {
          const tok = $match_19.$0;
          {
            ...
            if (_AMP_AMP3($dict_Eq_Int._EQ_EQ(newDepth)(0))(() => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)("=>")))) {
              ...
              if (_AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Equals))(() => $dict_Eq_Int._EQ_EQ(newDepth)(0))) {
                return false;
              } else {
                if (_AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Keyword))(() => $dict_Eq_Int._EQ_EQ(newDepth)(0))) {
                  {
...
var peekDecorator = (state) => ((cur) => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(cur.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(cur.lexeme)("@")) ? (($match_22) => {
  if ($match_22.$tag === 1) {
    return false;
  }
  if ($match_22.$tag === 0) {
    const next = $match_22.$0;
    return _PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(next.kind)(LowerIdentifier))(() => $dict_Eq_TokenKind._EQ_EQ(next.kind)(Keyword));
  }
  throw new Error("Pattern match failed");
...
var unquote = (lexeme) => _AMP_AMP3($dict_Ord_Int._GT_EQ(length(lexeme))(2))(() => _AMP_AMP3(startsWith('"')(lexeme))(() => endsWith('"')(lexeme))) ? slice(1)($dict_Num_Int._MINUS(length(lexeme))(1))(lexeme) : lexeme;
...
parseMoreRecordTypeFields = (lastField) => (state) => peekKind(Comma)(state) ? (($match_86) => {
  if ($match_86.$tag === 1) {
    return Ok([[], state]);
  }
  if ($match_86.$tag === 0) {
...
parseParenOrTupleType = (state) => ((start) => ((s1) => peekKind(RParen)(s1) ? ((s2) => Ok([TRef("Unit")([])({ start, end: previous(s2).span.end }), s2]))(advance(s1)) : (($match_92) => {
  if ($match_92.$tag === 1) {
    const e = $match_92.$0;
    return Err(e);
  }
...
parseMoreTupleTypes = (lastType) => (state) => peekKind(Comma)(state) ? (($match_95) => {
  if ($match_95.$tag === 1) {
    return Ok([[], state]);
  }
  if ($match_95.$tag === 0) {
...
parseTypeRef = (state) => ((tok) => _PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(LowerIdentifier))(() => $dict_Eq_TokenKind._EQ_EQ(tok.kind)(UpperIdentifier)) ? ((ident) => ((s1) => (($match_98) => {
  if ($match_98.$tag === 1) {
    const e = $match_98.$0;
    return Err(e);
  }
  if ($match_98.$tag === 0) {
    ...
    return ((isTypeCtor) => isTypeCtor ? (($match_99) => {
      ...
      if ($match_99.$tag === 0) {
        ...
        return ((endPos) => Ok([TRef(nameResult.name)(args)({ start: ident.span.start, end: endPos }), s3]))((($match_100) => {
          if ($match_100.$tag === 0) {
            const a = $match_100.$0;
      ...
      throw new Error("Pattern match failed");
    })(parseTypeApplicationArgs({ start: ident.span.start, end: nameResult.nameEnd })(s2)) : Ok([TRef(nameResult.name)([])({ start: ident.span.start, end: nameResult.nameEnd }), s2]))(_PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(ident.kind)(UpperIdentifier))(() => contains(".")(nameResult.name)));
  }
  throw new Error("Pattern match failed");
...
parseTypeApplicationArgs = (lastSpan) => (state) => _AMP_AMP3(isTypeStart(current(state)))(() => onSameLine(lastSpan)(current(state))) ? (($match_101) => {
  if ($match_101.$tag === 1) {
    const e = $match_101.$0;
    return Err(e);
  }
...
parseTypeAtom = (state) => ((tok) => (($match_103) => {
  ...
  {
    return _PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(LowerIdentifier))(() => $dict_Eq_TokenKind._EQ_EQ(tok.kind)(UpperIdentifier)) ? ((ident) => ((s1) => (($match_104) => {
      if ($match_104.$tag === 1) {
        const e = $match_104.$0;
        return Err(e);
      }
...
var parseDecoratedDeclaration = (state) => (($match_105) => {
  ...
  if ($match_105.$tag === 0) {
    ...
    return ((decoratorTok) => _PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(decoratorTok.kind)(LowerIdentifier))(() => $dict_Eq_TokenKind._EQ_EQ(decoratorTok.kind)(Keyword)) ? ((decorator) => ((s2) => (($match_106) => {
      if ($match_106.$tag === 1) {
        const e = $match_106.$0;
        return Err(e);
      }
...
var parseTypeParams = (state) => peekKind(LowerIdentifier)(state) ? ((tok) => ((s1) => (($match_110) => {
  if ($match_110.$tag === 1) {
    const e = $match_110.$0;
    return Err(e);
  }
...
var parseTypeParamsWithLayout = (typeLine) => (typeCol) => (state) => peekKind(LowerIdentifier)(state) ? ((tok) => _AMP_AMP3($dict_Eq_Int._SLASH_EQ(tok.span.start.line)(typeLine))(() => $dict_Ord_Int._LT_EQ(tok.span.start.column)(typeCol)) ? Ok([[], state]) : ((s1) => (($match_116) => {
  if ($match_116.$tag === 1) {
    const e = $match_116.$0;
    return Err(e);
  }
...
var parseRecordTypeFields = (state) => (($match_117) => {
  ...
  if ($match_117.$tag === 0) {
    ...
    return peekKind(RBrace)(s1) ? ((s2) => Ok([[], s2]))(advance(s1)) : (($match_118) => {
      if ($match_118.$tag === 1) {
        const e = $match_118.$0;
        return Err(e);
      }
...
var parseConstructorArgs = (lastSpan) => (state) => _AMP_AMP3(isTypeStart(current(state)))(() => _AMP_AMP3(onSameLine(lastSpan)(current(state)))(() => not(peekKind(Pipe)(state)))) ? (($match_120) => {
  if ($match_120.$tag === 1) {
    const e = $match_120.$0;
    return Err(e);
  }
  ...
  if ($match_122.$tag === 0) {
    ...
    return (($match_123) => {
      ...
      if ($match_123.$tag === 0) {
        ...
        return ((endPos) => Ok([{ name: nameTok.lexeme, args, span: { start: nameTok.span.start, end: endPos } }, s2]))((($match_124) => {
          if ($match_124.$tag === 0) {
            const a = $match_124.$0;
            return typeSpan(a).end;
          }
...
var parseMoreConstructors = (equalsCol) => (equalsLine) => (state) => peekKind(Pipe)(state) ? ((pipeTok) => _AMP_AMP3($dict_Eq_Int._SLASH_EQ(pipeTok.span.start.line)(equalsLine))(() => $dict_Eq_Int._SLASH_EQ(pipeTok.span.start.column)(equalsCol)) ? Err(makeError("Constructor variant '|' must align with '='")(pipeTok.span)) : ((s1) => (($match_125) => {
  if ($match_125.$tag === 1) {
    const e = $match_125.$0;
    return Err(e);
  }
      ...
      if ($match_130.$tag === 0) {
        ...
        return (($match_131) => {
          ...
          if ($match_131.$tag === 0) {
            ...
            return peekKind(Equals)(s3) ? ((eqTok) => ((s4) => ((equalsCol) => ((equalsLine) => peekKind(LBrace)(s4) ? (($match_132) => {
              if ($match_132.$tag === 1) {
                const e = $match_132.$0;
                return Err(e);
              }
              ...
              if ($match_133.$tag === 0) {
                ...
                return ((endPos) => Ok([DType(nameTok.lexeme)(params)(constraints)(ctors)({ start: typeTok.span.start, end: endPos }), s5]))((($match_134) => {
                  if ($match_134.$tag === 0) {
                    const c = $match_134.$0;
                    return c.span.end;
                  }
...
parseFPCtorPattern = (state) => ((ctor) => ((s1) => (($match_141) => {
  ...
  if ($match_141.$tag === 0) {
    ...
    return ((endPos) => Ok([PConstructor(ctor.lexeme)(args)({ start: ctor.span.start, end: endPos }), s2]))((($match_142) => {
      if ($match_142.$tag === 0) {
        const a = $match_142.$0;
...
parseFPTuplePattern = (state) => ((start) => ((s1) => peekKind(RParen)(s1) ? ((s2) => Ok([PTuple([])({ start, end: previous(s2).span.end }), s2]))(advance(s1)) : (($match_145) => {
  if ($match_145.$tag === 1) {
    const e = $match_145.$0;
    return Err(e);
  }
...
parseFPTupleRest = (lastPat) => (state) => peekKind(Comma)(state) ? (($match_148) => {
  if ($match_148.$tag === 1) {
    return Ok([[], state]);
  }
  if ($match_148.$tag === 0) {
...
parseFPRecordPattern = (state) => ((start) => ((s1) => peekKind(RBrace)(s1) ? ((s2) => Ok([PRecord([])({ start, end: previous(s2).span.end }), s2]))(advance(s1)) : (($match_151) => {
  if ($match_151.$tag === 1) {
    const e = $match_151.$0;
    return Err(e);
  }
...
parseRecordFieldPatterns = (state) => (($match_153) => {
  ...
  if ($match_153.$tag === 0) {
    ...
    return peekKind(Comma)(s1) ? ((s2) => (($match_154) => {
      if ($match_154.$tag === 1) {
        const e = $match_154.$0;
        return Err(e);
      }
...
parseRecordFieldPattern = (state) => (($match_155) => {
  ...
  if ($match_155.$tag === 0) {
    ...
    return peekKind(Equals)(s1) ? ((s2) => (($match_156) => {
      if ($match_156.$tag === 1) {
        const e = $match_156.$0;
        return Err(e);
      }
          ...
          if ($dict_Eq_TokenKind._EQ_EQ(next.kind)(UpperIdentifier)) {
            {
              const s1 = advance(state);
              {
                const $match_161 = expect(UpperIdentifier)("constructor name part")(s1);
                if ($match_161.$tag === 1) {
                  const e = $match_161.$0;
                  return Err(e);
                }
  ...
  if ($match_165.$tag === 0) {
    ...
    return (($match_166) => {
      ...
      if ($match_166.$tag === 0) {
        ...
        return ((endPos) => Ok([PConstructor(nameResult.name)(args)({ start: ctor.span.start, end: endPos }), s3]))((($match_167) => {
          if ($match_167.$tag === 0) {
            const a = $match_167.$0;
            return patSpan(a).end;
          }
...
parseConstructorPatternArgs = (state) => isPatternStart(current(state)) ? (($match_168) => {
  ...
  throw new Error("Pattern match failed");
})(parsePrimaryPattern(state)) : Ok([[], state]);
parseListPattern = (state) => ((start) => ((s1) => peekKind(RBracket)(s1) ? ((s2) => Ok([PList([])({ start, end: previous(s2).span.end }), s2]))(advance(s1)) : (($match_170) => {
  if ($match_170.$tag === 1) {
    const e = $match_170.$0;
    return Err(e);
  }
...
parsePatternList = (state) => (($match_172) => {
  ...
  if ($match_172.$tag === 0) {
    ...
    return peekKind(Comma)(s1) ? ((s2) => (($match_173) => {
      if ($match_173.$tag === 1) {
        const e = $match_173.$0;
        return Err(e);
      }
...
parseParenOrTuplePattern = (state) => ((start) => ((s1) => peekKind(RParen)(s1) ? ((s2) => Ok([PTuple([])({ start, end: previous(s2).span.end }), s2]))(advance(s1)) : (($match_174) => {
  if ($match_174.$tag === 1) {
    const e = $match_174.$0;
    return Err(e);
  }
...
parseTuplePatternRest = (lastPat) => (state) => peekKind(Comma)(state) ? (($match_177) => {
  if ($match_177.$tag === 1) {
    return Ok([[], state]);
  }
  if ($match_177.$tag === 0) {
...
var parseFieldAccesses = (expr) => (state) => {
  while (true) {
    {
      const $match_183 = matchKind(Dot)(state);
      if ($match_183.$tag === 1) {
      ...
      if ($match_183.$tag === 0) {
        const s1 = $match_183.$0;
        {
          ...
          if (_PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(LowerIdentifier))(() => $dict_Eq_TokenKind._EQ_EQ(tok.kind)(UpperIdentifier))) {
            {
              const field = tok;
              {
                const s2 = advance(s1);
...
var parseInfixOperator = (state) => peekKind(LParen)(state) ? ((s1) => (($match_188) => {
  if ($match_188.$tag === 1) {
    const e = $match_188.$0;
    return Err(e);
  }
  ...
  throw new Error("Pattern match failed");
})(expect(Operator)("operator")(s1)))(advance(state)) : (($match_190) => {
  if ($match_190.$tag === 1) {
    const e = $match_190.$0;
    return Err(e);
  }
  ...
  if ($match_191.$tag === 0) {
    ...
    return (($match_192) => {
      ...
      if ($match_192.$tag === 0) {
        ...
        return ((assocStr) => Ok([DInfix(assocStr)(stringToInt(precTok.lexeme))(opResult.opName)({ start, end: opResult.opEnd }), s3]))((($match_193) => {
          if ($match_193 === "infixl") {
            return "left";
          }
          if ($match_193 === "infixr") {
...
parseAnnotationOrValue = (state) => (($match_194) => {
  ...
  if ($match_194.$tag === 0) {
    ...
    return peekKind(Colon)(s1) ? ((s2) => (($match_195) => {
      if ($match_195.$tag === 1) {
        const e = $match_195.$0;
        return Err(e);
      }
      ...
      throw new Error("Pattern match failed");
    })(parseTypeExpression(s2)))(advance(s1)) : (($match_196) => {
      if ($match_196.$tag === 1) {
        const e = $match_196.$0;
        return Err(e);
      }
      ...
      if ($match_198.$tag === 0) {
        ...
        return (($match_199) => {
          ...
          if ($match_199.$tag === 0) {
            ...
            return ((bodyTok) => _AMP_AMP3($dict_Eq_Int._SLASH_EQ(bodyTok.span.start.line)(eqTok.span.start.line))(() => $dict_Ord_Int._LT_EQ(bodyTok.span.start.column)(col)) ? Err(makeError($dict_Appendable_String._PLUS_PLUS("Function body must be indented past column ")(intToStr(col)))(bodyTok.span)) : (($match_201) => {
              if ($match_201.$tag === 1) {
                const e = $match_201.$0;
                return Err(e);
              }
                          ...
                          if ($match_208.$tag === 0) {
                            ...
                            return (($match_209) => {
                              ...
                              if ($match_209.$tag === 0) {
                                ...
                                return ((methods) => ((endPos) => Ok([DProtocol(nameTok.lexeme)(params)(constraints)(methods)({ start: protocolTok.span.start, end: endPos }), s8]))((($match_210) => {
                                  if ($match_210.$tag === 0) {
                                    const m = $match_210.$0;
                                    return m.span.end;
                                  }
...
parseProtocolItem = (state) => ((start) => (($match_214) => {
  ...
  if ($match_214.$tag === 0) {
    ...
    return peekKind(Colon)(s1) ? ((s2) => (($match_215) => {
      if ($match_215.$tag === 1) {
        const e = $match_215.$0;
        return Err(e);
      }
      ...
      throw new Error("Pattern match failed");
    })(parseTypeExpression(s2)))(advance(s1)) : (($match_216) => {
      if ($match_216.$tag === 1) {
        const e = $match_216.$0;
        return Err(e);
      }
              ...
              if ($match_222.$tag === 0) {
                ...
                return (($match_223) => {
                  ...
                  if ($match_223.$tag === 0) {
                    ...
                    return ((endPos) => Ok([DImplementation(constraints)(protocolTok.lexeme)(typeArgs)(methods)({ start: implTok.span.start, end: endPos }), s5]))((($match_224) => {
                      if ($match_224.$tag === 0) {
                        const m = $match_224.$0;
                        return m.span.end;
                      }
...
parseUnary = (baseIndentFloor) => (state) => ((tok) => _AMP_AMP3($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Operator))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)("-")) ? (($match_238) => {
  if ($match_238.$tag === 1) {
    return parseApplication(baseIndentFloor)(state);
  }
  if ($match_238.$tag === 0) {
    const nextTok = $match_238.$0;
    return _PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(nextTok.kind)(LowerIdentifier))(() => _PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(nextTok.kind)(UpperIdentifier))(() => _PIPE_PIPE3($dict_Eq_TokenKind._EQ_EQ(nextTok.kind)(NumberToken))(() => $dict_Eq_TokenKind._EQ_EQ(nextTok.kind)(LParen)))) ? ((s1) => (($match_239) => {
      if ($match_239.$tag === 1) {
        const e = $match_239.$0;
        return Err(e);
      }
  ...
  if ($match_240.$tag === 0) {
    ...
    return ((baseIndent) => ((effectiveIndent) => (($match_241) => {
      ...
      if ($match_241.$tag === 0) {
        ...
        return isEmpty2(args) ? Ok([callee, s2]) : ((endPos) => Ok([EApply(callee)(args)({ start: exprSpan(callee).start, end: endPos }), s2]))((($match_242) => {
          if ($match_242.$tag === 0) {
            const a = $match_242.$0;
                  ...
                  if ($match_270.$tag === 0) {
                    ...
                    return (($match_271) => {
                      ...
                      if ($match_271.$tag === 0) {
                        ...
                        return ((endPos) => Ok([ECase(discriminant)(branches)({ start: caseTok.span.start, end: endPos }), s6]))((($match_272) => {
                          if ($match_272.$tag === 0) {
                            const b = $match_272.$0;
                            return b.span.end;
                          }
...
parseParenExpr = (state) => ((start) => ((s1) => peekKind(RParen)(s1) ? ((s2) => Ok([EUnit({ start, end: previous(s2).span.end }), s2]))(advance(s1)) : peekKind(Operator)(s1) ? (($match_279) => {
  if ($match_279.$tag === 0) {
...
parseMoreTupleExprs = (lastExpr) => (state) => peekKind(Comma)(state) ? (($match_283) => {
  if ($match_283.$tag === 1) {
    return Ok([[], state]);
  }
  if ($match_283.$tag === 0) {
...
parseListExpr = (state) => ((start) => ((s1) => peekKind(RBracket)(s1) ? ((s2) => Ok([EList([])({ start, end: previous(s2).span.end }), s2]))(advance(s1)) : (($match_286) => {
  if ($match_286.$tag === 1) {
    const e = $match_286.$0;
    return Err(e);
  }
...
parseMoreListExprs = (lastExpr) => (state) => peekKind(Comma)(state) ? (($match_292) => {
  if ($match_292.$tag === 1) {
    return Ok([[], state]);
  }
  if ($match_292.$tag === 0) {
...
parseRecordExpr = (state) => ((start) => ((s1) => peekKind(RBrace)(s1) ? ((s2) => Ok([ERecord([])({ start, end: previous(s2).span.end }), s2]))(advance(s1)) : (($match_295) => {
  if ($match_295.$tag === 1) {
    const e = $match_295.$0;
    return Err(e);
  }
...
parseMoreRecordFields = (baseIndent) => (lastField) => (state) => peekKind(Comma)(state) ? (($match_309) => {
  if ($match_309.$tag === 1) {
    return Ok([[], state]);
  }
  if ($match_309.$tag === 0) {
...
var parseDeclarations = (state) => isAtEnd(state) ? Ok([[], state]) : ((tok) => $dict_Eq_Int._EQ_EQ(tok.span.start.column)(1) ? (($match_313) => {
  if ($match_313.$tag === 1) {
    const e = $match_313.$0;
    return Err(e);
  }
...
var parseProgram = (state) => ((tok) => $dict_Eq_Int._EQ_EQ(tok.span.start.column)(1) ? (($match_315) => {
  if ($match_315.$tag === 1) {
    const e = $match_315.$0;
    return Err(e);
  }
...
$impl_Eq_Error__EQ_EQ = (x_impl) => (y_impl) => (($match_39) => {
  if ($match_39[0].$tag === 0 && $match_39[1].$tag === 0) {
    ...
    return _AMP_AMP4($dict_Eq_String._EQ_EQ(a_0)(b_0))(() => $dict_Eq_Error._EQ_EQ(a_1)(b_1));
  }
  if ($match_39[0].$tag === 1 && $match_39[1].$tag === 1) {
    ...
    const b_0 = $match_39[1].$0;
    const b_1 = $match_39[1].$1;
    return _AMP_AMP4($dict_Eq_Int._EQ_EQ(a_0)(b_0))(() => $dict_Eq_Error._EQ_EQ(a_1)(b_1));
  }
...
var isIdentifierStart = (c) => _PIPE_PIPE4(isAlpha(c))(() => $dict_Eq_Char._EQ_EQ(c)("_"));
var isIdentifierPart = (c) => _PIPE_PIPE4(isIdentifierStart(c))(() => isDigit(c));
var isWhitespace = (c) => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)(" "))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("\t"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)(`
`))(() => $dict_Eq_Char._EQ_EQ(c)("\r"))));
var isOperatorChar = (c) => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("!"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("#"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("$"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("%"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("&"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("*"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("+"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("."))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("/"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("<"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("="))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)(">"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("?"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("@"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("\\"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("^"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("|"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)("~"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)(":"))(() => $dict_Eq_Char._EQ_EQ(c)("-"))))))))))))))))))));
...
skipWsDispatch = (sawNl) => (state) => (c) => isWhitespace(c) ? ((nl) => skipWhitespaceAndComments(nl)(skip(state)))(_PIPE_PIPE4(sawNl)(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(c)(`
    ...
    return (($match_14) => {
      if ($match_14 === "-") {
        return ((lineBefore) => ((s2) => (($match_15) => {
          ...
          if ($match_15.$tag === 0) {
            const s3 = $match_15.$0;
            return ((nl) => skipWhitespaceAndComments(nl)(s3))(_PIPE_PIPE4(sawNl)(() => $dict_Ord_Int._GT(s3.line)(lineBefore)));
          }
          throw new Error("Pattern match failed");
  ...
  while (true) {
    {
      ...
      if ($match_16.$tag === 0) {
        const c = $match_16.$0;
        if (_PIPE_PIPE4(isIdentifierPart(c))(() => $dict_Eq_Char._EQ_EQ(c)("'"))) {
          state = skip(state);
          continue;
        } else {
          return state;
...
var isValidStringEscape = (esc) => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(esc)("n"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(esc)("r"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(esc)("t"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(esc)('"'))(() => $dict_Eq_Char._EQ_EQ(esc)("\\")))));
var readStringBody;
...
var isValidCharEscape = (esc) => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(esc)("n"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(esc)("r"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(esc)("t"))(() => _PIPE_PIPE4($dict_Eq_Char._EQ_EQ(esc)("'"))(() => $dict_Eq_Char._EQ_EQ(esc)("\\")))));
...
var maybeInsertNewline = (tokens) => (sawNl) => (hasEmitted) => (state) => _AMP_AMP5(sawNl)(() => hasEmitted) ? ((nlPos) => ((nlToken) => _COLON_COLON(nlToken)(tokens))({ kind: Newline, lexeme: `
  ...
  while (true) {
    {
      ...
      if (Array.isArray($match_5) && $match_5.length >= 1) {
        ...
        if (_AMP_AMP6($dict_Eq_TokenKind._EQ_EQ(tok.kind)(Keyword))(() => _PIPE_PIPE5($dict_Eq_String._EQ_EQ(tok.lexeme)("infix"))(() => _PIPE_PIPE5($dict_Eq_String._EQ_EQ(tok.lexeme)("infixl"))(() => $dict_Eq_String._EQ_EQ(tok.lexeme)("infixr"))))) {
          {
            const $match_6 = rest;
